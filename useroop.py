...
class PyBuddy:
    ...
    def __init__(self, name, species, num_legs, weight_kgs, is_available, skill_list, experience, speed):
        ...
        self.speed = speed
        self.leave = self.random.randrange(1,8)
        self.test = self.random.randrange(70,100)
    ...
    def __str__(self):
        ...
        s7 = f"My experience level for this subject is {self.experience}.\n"
        s8 = f"As for speed capabilities, I am {self.speed}.\n"
        s9 = f"I have to leave in {self.leave} hours.\n"
        s10 = f"My overall average test score average is {self.test}.\n"
    ...
    def get_leave_hours(self):
        leave = self.random.randrange(1,8)
        return leave

    def get_avg_test(self):
        test = self.random.randrange(70,100)
        return test
...
if __name__ == "__main__":
 ...
 # Create another instance of a PyBuddy
    ...
    bob = PyBuddy(
        ...
        weight_kgs=84.3452,
        is_available=True,
        skill_list=["Small Places", "Toys", "Helping", "Cold Temperatures", "Pressure Situations"],
...
# Create another instance of a PyBuddy
    ...
    jigsaw = PyBuddy(
        ...
        weight_kgs=165.7342,
        is_available=True,
        skill_list=["Crosswords", "Suduko", "Jumble", "Jigsaw", "Connect the Dots"],
        experience="Expert",
        speed="Fast",
    )

    jigsaw.display_welcome()
